...
${OBJECTDIR}/ai/AiManager.o: ai/AiManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/ai
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ai/AiManager.o ai/AiManager.cpp

${OBJECTDIR}/entity/Goal.o: entity/Goal.cpp 
	${MKDIR} -p ${OBJECTDIR}/entity
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/entity/Goal.o entity/Goal.cpp

${OBJECTDIR}/ai/AiAgent.o: ai/AiAgent.cpp 
	${MKDIR} -p ${OBJECTDIR}/ai
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ai/AiAgent.o ai/AiAgent.cpp
